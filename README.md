...
|이름|닉네임|역할|활동|
|:---:|:---:|:---:|:---|
||Adel-Hart|조장|**아이디어 제공, 전반적인 시스템 구상, 버그 생산,</br>서버 프로토콜 및 로직 설계.**|
||luckhyoen|팀원|**캐릭터 디자인, 타일 디자인**|
||silverkjw|팀원|**플레이 시스템 개발, 플레이 시스템 아이디어 제공, 서버 개발 참여, 버그 해결, 맵디자인**|
||Plana095|팀원|**맵 디자인, 에디터 개발**|
